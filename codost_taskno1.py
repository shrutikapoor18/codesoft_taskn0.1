...
#Adding_Task in To-Do-List

def add_task(tasks, task):
    tasks.append(task)
    print("Task added successfully.")

#Viewing_task in To-Do-List
